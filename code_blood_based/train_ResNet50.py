...
def train_model(model, criterion, optimizer, scheduler, modelName, num_epochs=25):
        ...
        for phase in ['train', 'val']:
            ...
            for inputs, labels in dataloaders[phase]:
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    ...
                    #label_onehot = labels.scatter(0,labels,1)
    ...
    write_to_excel(train_index_arrays, eval_index_arrays, save_excel_path + 'ResNet18.xlsx')
...
def main():
    ...
    # for param in model_ft.parameters(): # 冻结所有参数,不被更新
    ...
    # param_to_update = [] # 用来保存需要更新的参数
    # for param in model_ft.named_parameters():
    #     if param.requireds_grad == True:
    ...
    model_ft = train_model(model_ft, criterion, optimizer_ft, exp_lr_scheduler,
                           modelName='ResNet50', num_epochs=35)
