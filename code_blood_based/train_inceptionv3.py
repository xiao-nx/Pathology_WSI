...
def train_model(model, criterion, optimizer, scheduler, modelName, num_epochs=25):
    ...
    write_to_excel(train_index_arrays, eval_index_arrays, save_excel_path + 'inception_v3.xlsx')
...
def main():
    num_classes = 2
    model_ft = models.inception_v3(pretrained=True) # 读取预训练模型参数
    ...
    model_ft = train_model(model_ft, criterion, optimizer_ft, exp_lr_scheduler,
                           modelName='inception_v3', num_epochs=35)
