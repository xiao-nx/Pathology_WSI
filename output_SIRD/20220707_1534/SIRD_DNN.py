...
parser.add_argument('--epoches_per_eval', type=int, default=1000,
...
def solve_SIRD2COVID(params):
    ...
    train_data, test_data = dataUtils.split_data(date, data2S, data2I, data2R, data2D, train_size=0.75, normalFactor=params['normalize_population'])
    # 按顺序取出列表中的数据
