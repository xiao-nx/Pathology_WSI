...
MODEL_PATH = './models_based_person/'
...
data_transforms = {
    'train': transforms.Compose([
        # transforms.RandomApply(image_transforms, p=0.5),
...
def train_model(model, criterion, optimizer, scheduler, modelName, num_epochs=25):
    ...
    write_to_excel(train_index_arrays, eval_index_arrays, save_excel_path + 'ResNet50.xlsx')
